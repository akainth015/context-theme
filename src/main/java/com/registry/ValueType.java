...
public enum ValueType {
	 ...
	 */
	REG_NONE               (RegistryKey.REG_NONE,                "REG_NONE"),
	
	/**
	 * A string value.
	 */
	REG_SZ                 (RegistryKey.REG_SZ,                  "REG_SZ"),
	
	/**
	 * A string value that contains unexpanded references to environment variables.
	 */
	REG_EXPAND_SZ          (RegistryKey.REG_EXPAND_SZ,           "REG_EXPAND_SZ"),
	
	/**
	 * Binary data in any form.
	 */
	REG_BINARY             (RegistryKey.REG_BINARY,              "REG_BINARY"),
	
	/**
	 * A 32-bit number.
	 */
	REG_DWORD              (RegistryKey.REG_DWORD,               "REG_DWORD"),
	 ...
	 */
	REG_DWORD_LITTLE_ENDIAN(RegistryKey.REG_DWORD_LITTLE_ENDIAN, "REG_DWORD_LITTLE_ENDIAN"),
	 ...
	 */
	REG_DWORD_BIG_ENDIAN   (RegistryKey.REG_DWORD_BIG_ENDIAN,    "REG_DWORD_BIG_ENDIAN"),
	 ...
	 */
	REG_LINK               (RegistryKey.REG_LINK,                "REG_LINK"),
	
	/**
	 * An array of string values.
	 */
	REG_MULTI_SZ           (RegistryKey.REG_MULTI_SZ,            "REG_MULTI_SZ"),
	
	/**
	 * Resource list in the resource map.
	 */
	REG_RESOURCE_LIST      (RegistryKey.REG_RESOURCE_LIST,       "REG_RESOURCE_LIST"),
	
	/**
	 * Resource list in the hardware description.
	 */
	REG_FULL_RESOURCE_DESCRIPTOR (RegistryKey.REG_FULL_RESOURCE_DESCRIPTOR, "REG_FULL_RESOURCE_DESCRIPTOR"),
	
	REG_RESOURCE_REQUIREMENTS_LIST (RegistryKey.REG_RESOURCE_REQUIREMENTS_LIST, "REG_RESOURCE_REQUIREMENTS_LIST"),
	
	/**
	 * A 64-bit number.
	 */
	REG_QWORD              (RegistryKey.REG_QWORD,               "REG_QWORD"),
	 ...
	 */
	REG_QWORD_LITTLE_ENDIAN(RegistryKey.REG_QWORD_LITTLE_ENDIAN, "REG_QWORD_LITTLE_ENDIAN");
