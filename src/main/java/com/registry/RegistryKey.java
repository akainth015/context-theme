...
public class RegistryKey implements Cloneable, Comparable<RegistryKey>, java.io.Serializable {
    ...
    /**
     * Constant for {@link RegistryWatcher} to notify caller if a subkey is added or deleted.
     */
    public static final int REG_NOTIFY_CHANGE_NAME = 0x00000001;

    /**
     * Constant for {@link RegistryWatcher} to notify caller of changes
    ...
    /**
     * Constant for {@link RegistryWatcher} combining all of the possible filters.
     */
            ...
            if (info != null) {
                ...
                if (this.lastError == ERROR_SUCCESS) {
                    ...
                    if (type == null) {
                        ...
                        switch (type) {
                            case REG_SZ:
                                value = new RegStringValue(
                                        this, name, type, (String) data);
                                break;
                            case REG_EXPAND_SZ:
                                value = new RegStringValue(
                                        this, name, type,
                            ...
                            case REG_FULL_RESOURCE_DESCRIPTOR:
                            case REG_RESOURCE_REQUIREMENTS_LIST:
                                value = new RegBinaryValue(
                                        this, name, type, (byte[]) data);
                                break;
                            case REG_DWORD:
                            case REG_DWORD_LITTLE_ENDIAN:
                            case REG_DWORD_BIG_ENDIAN:
                                value = new RegDWORDValue(
                                        this, name, type, (Integer) data);
                                break;
                            case REG_MULTI_SZ:
                                value = new RegMultiStringValue(
                                        this, name, type, (String[]) data);
                                break;
                            case REG_QWORD:
                            case REG_QWORD_LITTLE_ENDIAN:
                                value = new RegQWORDValue(
                                        this, name, type, (Long) data);
                                break;
                        }
                    }
                }
                ...
                if (this.lastError == ERROR_SUCCESS) {
                    ...
                    if (type == null) {
                        ...
                        switch (type) {
                            ...
                            case REG_FULL_RESOURCE_DESCRIPTOR:
                            case REG_RESOURCE_REQUIREMENTS_LIST:
                                list.add(new RegBinaryValue(
                                        this, name, type, (byte[]) value));
                                break;
                            case REG_DWORD:
                            case REG_DWORD_LITTLE_ENDIAN:
                            case REG_DWORD_BIG_ENDIAN:
                                list.add(new RegDWORDValue(
                                        this, name, type, (Integer) value));
                                break;
                            case REG_MULTI_SZ:
                                list.add(new RegMultiStringValue(
                                        this, name, type, (String[]) value));
                                break;
                            case REG_QWORD:
                            case REG_QWORD_LITTLE_ENDIAN:
                                list.add(new RegQWORDValue(
                                        this, name, type, (Long) value));
                                break;
                        }
                    }
                }
                    ...
                    if (info != null) {
                        if (((Integer) info[ERROR_CODE]).intValue() == ERROR_SUCCESS) {
                            ...
                            if (type == null) {
                                ...
                                switch (type) {
                                    case REG_SZ:
                                        result = new RegStringValue(
                                                RegistryKey.this, value, type, (String) data);
                                        break;
                                    case REG_EXPAND_SZ:
                                        result = new RegStringValue(
                                    ...
                                    case REG_FULL_RESOURCE_DESCRIPTOR:
                                    case REG_RESOURCE_REQUIREMENTS_LIST:
                                        result = new RegBinaryValue(
                                                RegistryKey.this, value, type, (byte[]) data);
                                        break;
                                    case REG_DWORD:
                                    case REG_DWORD_LITTLE_ENDIAN:
                                    case REG_DWORD_BIG_ENDIAN:
                                        result = new RegDWORDValue(
                                                RegistryKey.this, value, type, (Integer) data);
                                        break;
                                    case REG_MULTI_SZ:
                                        result = new RegMultiStringValue(
                                                RegistryKey.this, value, type, (String[]) data);
                                        break;
                                    case REG_QWORD:
                                    case REG_QWORD_LITTLE_ENDIAN:
                                        result = new RegQWORDValue(
                                                RegistryKey.this, value, type, (Long) data);
                                        break;
                                }
                            }
                        }
